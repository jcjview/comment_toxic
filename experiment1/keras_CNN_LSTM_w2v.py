...
def get_model():
    ...
    main = Conv1D(filters=64, kernel_size=5, padding='valid', activation='relu')(main)
    main = MaxPooling1D(pool_size=4)(main)
    main = Bidirectional(LSTM(50, return_sequences=True, dropout=0.1, recurrent_dropout=0.1))(main)
