...
blend[col] = \
    (0.01 *minmax_scale (sup[col].values) + \
    ...
    0.05 * minmax_scale(p10[col].values)) /(0.01+0.1+0.05+0.2+0.05+0.25+0.1+0.1+0.1+0.05+0.05)
...
blend.to_csv("submit_ensemble/20180320/ensemble_0320finalv-3_ms.csv.gz", index=False,float_format='%.9f', compression='gzip')
