...
prepare embeddings
"""
embedding_matrix_path="attention_embedding_layer.npz"
...
def get_model(word_index):
    ...
    preds = Dense(1, activation='sigmoid',name='logist')(merged)
...
def train_fit_predict(model, data,y):
    ...
    STAMP = 'simple_lstm_pretrain_%.2f_%.2f' % (rate_drop_lstm, rate_drop_dense)
    print(STAMP)
